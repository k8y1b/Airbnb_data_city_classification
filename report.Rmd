...
This report considered classification models to determine the different cities based on the AirBnb data. Seven different classification models were applied to the dataset. Out of the seven proposed models, the lasso classifier presented the best performance.

The plots below show different values of lambda for the lasso and the ridge regressions. It also shows the number of predictors that were used in each model. Lasso performs better because it uses a subset of the predictors, and some of the predictors were not useful in the final model. Therefore, the accuracy of the lasso regression model with fewer predictors outperformed the ridge regression.
